...
# Use a neural network to solve a 1st-order ODE BVP, with 2 Dirichlet BC.
...
if __name__ == '__main__':
    ...
    # Print the report.
    print('   yt       ya      dyt_dx    dya_dx  d2yt_dx2 d2ya_dx2')
    for i in range(ntrain):
        print('%f %f %f %f %f %f' %
              (yt[i], ya[i], dyt_dx[i], dya_dx[i], d2ya_dx2[i], d2yt_dx2[i])
        )
    print('MSE      %f           %f           %f' %
