...
# Use a neural network to solve a 2nd-order ODE.
...
parser = argparse.ArgumentParser(description = 'Solve a ODE with a neural net',
                                 formatter_class =
                                 argparse.ArgumentDefaultsHelpFormatter,
                                 epilog = '''
                                 Experiment with the settings to find what
                                 works.
                                 '''
                                 )
# print('parser =', parser)
