...
if __name__ == '__main__':
    ...
    #     m = len(pde2diff1d.bcf)
    #     assert(m == 2)

    #     # Create the neural network.
    #     net = NNPDE2DIFF(pde2diff1d)
    ...
    #         for ii in range(n1):
    #             for jj in range(m):
    #                 delYa[ii,jj] = net.eq.delYaf[jj](x_train1[ii])
    ...
    #         for ii in range(n1):
    #             for jj in range(m):
    #                 del2Ya[ii,jj] = net.eq.del2Yaf[jj](x_train1[ii])
