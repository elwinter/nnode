"""
PDE2DIFF2D - Base class for 2-D diffusion equations

This module provides the base functionality for all 2-D diffusion equation
objects used in the nnode software.

Example:
    Create an empty PDE2DIFF2D object.
        pde2diff2d = PDE2DIFF2D()
    Create an PDE2DIFF2D object from a Python module.
        pde2diff2d = PDE2DIFF2D(modname)
