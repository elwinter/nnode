...
half-sine wave+0.5, with amplitude 0.5, and boundaries at x=0,1 fixed at 0.5.
...
def Yaf(xt):
    """Analytical solution"""
    (x, t) = xt
    Ya = 0.5*(1 + exp(-pi**2*D*t)*sin(pi*x))
    return Ya
